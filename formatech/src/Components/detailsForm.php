        ...
        <article>
            <div>
                <form action="" method="post">
                    <input id="input_type" type="hidden" name="centers" />
                        ...
                        <tr>
                            <form action="" method="post">
                                ...
                                <td class="containerInput">
                                    ...
                                    <input id="input_id" type="hidden" name="center_id" value="<?= $this->center["center_id"] ?>">
                                </td>
                        ...
                        <tr>
                            <form action="" method="post">
                                ...
                                <td class="containerInput">
                                    ...
                                    <input id="center_name" type="hidden" name="center_name" value="<?= $this->center["center_name"] ?>">
                                    <input id="center_id" type="hidden" name="center_id" value="<?= $this->center["center_id"] ?>">
                                </td>
                                <td class="btns-container">
